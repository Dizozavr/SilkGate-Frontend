  ...
  return (
    <div className="min-h-screen bg-[#10182A] flex flex-col items-center justify-center px-2 sm:px-0">
      <div className="w-full max-w-md p-8 bg-[#F5F6FA] rounded-lg shadow text-center">
        <h2 className="text-2xl font-bold mb-6 text-[#10182A]">Добро пожаловать в SilkGate!</h2>
        <p className="mb-6 text-[#232B45]">Вы вошли как обычный пользователь. Выберите, кем хотите стать:</p>
